package org.example.APIManagementSvc.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* org.example.APIManagementSvc.controller..*(..))")
    public void controllerPointcut() {}

    /** 서비스 레이어의 모든 메소드를 대상으로 하는 포인트컷 */
    @Pointcut("execution(* org.example.APIManagementSvc.service..*(..))")
